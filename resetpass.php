...
if (isset($_POST['send'])) {
    ...
    $cp=$_POST['cp'];
   if ($p!=$cp) {
    $error="Your Password not much";
   }
   else{
    $pass=md5($p);
$update=$conn->query("UPDATE users SET password='$pass' where vkey='$vkeys'");

   }
   if ($update) {
    ?>
    <script>
        window.alert('Password reseted and now you may login')
        window.location.href='backemail.php'
    </script>
    <?php
       // code...
   }
    ...
    <div class="row g-1 py-1">
          <div class="col">
              <div class="position-relative">
                <input type="password" class="form-control ps-4" placeholder="Choose Password" name="p">
...
<div class="row g-1 py-1">
          <div class="col">
              <div class="position-relative">
                <input type="password" class="form-control ps-4" placeholder="Confrim Password" name="cp">
            <i class="fa fa-key text-info position-absolute" aria="true" style="top:10px;left:5px"></i>
            </div>
           </div>
        </div>
        ...
        <div class="row g-1 py-2">
          <div class="col">
              <div class="position-relative">
                <p class="text-end"><a href="forgotpass.php" style="text-decoration:none;color:red" >Forgot password?</a></p>
            </div>
           </div>
