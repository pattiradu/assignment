...
$selo=$conn->query("SELECT * FROM users where email='$email' and password='$pass' and verify='1'");
$cond=mysqli_num_rows($selo);
if ($cond) {
    $rows=mysqli_fetch_array($selo);
...
<p class="text-center">Hi,<?php echo $_SESSION['uname'];?></p>
