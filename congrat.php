...
<i class="fa fa-user-circle-o text-info bg-white " aria-hidden="true" style="font-size:60px;top:-43px;position:absolute;left:20vh"> </i>
    <form action="">

    
        <br><br><p class="text-center">congrat,<?php echo $_SESSION['name'];?> !</p>
        
        <br><br><div class="row g-1 py-1">
          <div class="col" >
            ...
            <div class="col">
              <div class="position-relative">
            <input type="text" class="form-control ps-4" style="border-radius:50px;"  value="<?php echo $_SESSION['email'];?>" readonly>
